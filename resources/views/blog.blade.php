...
<body>
  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a href="index.blade.php" class="navbar-brand">Digi<span class="text-primary">Gram.</span></a>
        ...
        <div class="navbar-collapse collapse" id="navbarContent">
          <ul class="navbar-nav ml-lg-4 pt-3 pt-lg-0">
            ...
            <li class="nav-item">
              <a href="about.blade.php" class="nav-link">About</a>
            </li>
            <li class="nav-item">
              <a href="services.blade.php" class="nav-link">Services</a>
            </li>
            <li class="nav-item active">
              <a href="blog.blade.php" class="nav-link">News</a>
            </li>
            <li class="nav-item">
              <a href="contact.blade.php" class="nav-link">Contact</a>
            </li>
          </ul>
